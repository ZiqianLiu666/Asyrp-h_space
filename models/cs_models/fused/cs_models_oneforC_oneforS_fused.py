...
class CompositionalLayer_mlp(nn.Module):
    ...
    def forward(self, f1, f2):
        """
        :param f1: shared-modality fts，shape [B, HW, F]
        :param f2: specific-modality fts，shape [B, HW, F]
        :return: fused features, shape [B, HW, F]
        """
...
class ConvMappingNetwork_cs_Unet_fused(nn.Module):
    """
    ...
    def forward(self, z, no_fused=False, eval_visul=False):
        B, C, H, W = z.shape
        # Input: [B, 512, 8, 8]
